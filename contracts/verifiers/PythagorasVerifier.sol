...
contract PythagorasVerifier {
    ...
    uint256 constant Qlx  = 11061768654402029366013515682522360582550291908840061488505685296538451527254;
    uint256 constant Qly  = 15471600944923485559452784938718837008623891847925721777620478053180790737461;
    uint256 constant Qrx  = 11448008371105398943869362113810658997753184086726857543614610338733680103806;
    uint256 constant Qry  = 8526946509698979755701815775739707350493042104526490190408488647604655638122;
    uint256 constant Qox  = 11417277899075430604770434269880819725304375503216236587767173094679019570847;
    uint256 constant Qoy  = 6543395296813345384304199905094388711319556926105207124271547473226589676469;
    uint256 constant Qcx  = 0;
    uint256 constant Qcy  = 0;
    uint256 constant S1x  = 7918996172219386295704521183819205952088645185718821264523139557196406611774;
    uint256 constant S1y  = 18241057293545811364170150548902277646716818548360251998847516104141099611496;
    uint256 constant S2x  = 711545892626180513471403042031241695523966026880927433000273155143947215114;
    uint256 constant S2y  = 12900839569779827099988758485946384810772554052279167178798448800403150738937;
    uint256 constant S3x  = 10602638595357484529514252613879624122103895786001250478976706546743832291793;
    uint256 constant S3y  = 20529981353225414621581824290818764730356644360811324751475405681369672112062;
