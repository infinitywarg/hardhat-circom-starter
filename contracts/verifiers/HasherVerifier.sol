...
contract HasherVerifier {
    
    uint32 constant n =   4096;
    uint16 constant nPublic =  1;
    uint16 constant nLagrange = 1;
    
    uint256 constant Qmx = 13673392657122498893768685482919823881745605810499225225668376457375133381858;
    uint256 constant Qmy = 4933720099527936909944375096380002987745363489108827181432408055038928610821;
    uint256 constant Qlx = 1879179129635088578779265413328731120762735636529838066628099563082401161264;
    uint256 constant Qly = 1242171113760015375752332635236385601527294741119313505741713759947716641706;
    uint256 constant Qrx = 11207261264480442569054884902847738782658515462055726795096533447935013734389;
    uint256 constant Qry = 14511101718995562635634788801256995304746824483515377293620548190925041821393;
    uint256 constant Qox = 4378224304120633056446191142613351511091320569859685660245375223138141336004;
    uint256 constant Qoy = 306395363676980792928851331099397744530486679805455901808017979033562906175;
    uint256 constant Qcx = 20709950297148828225446682926526657621454202351743474539440508230114663955735;
    uint256 constant Qcy = 9974129360134388312298969611520408991694276197254942445176951008263112971251;
    uint256 constant S1x = 10994496039554535219866050398579688664825721184899771203587631473643422595726;
    uint256 constant S1y = 2721653132260042395775755322797723053689440635868664118620972448972225532436;
    uint256 constant S2x = 4688453942609191376562004534146898798543330434607085024685951393445029195190;
    uint256 constant S2y = 9904111344157551555977756039380670793625907745308818529705320507036949588816;
    uint256 constant S3x = 4171628096582767453418288241419289761262215827922111878145335814426849873178;
    uint256 constant S3y = 19163278580612271253914025778511104837162809585654837029749835105270245801919;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 = 18153346570428539980710339168569268796505083666568514385137005240186998907329;
    uint256 constant X2x2 = 16269240302762703765036813216268014744474363601345626542673511865619626093320;
    uint256 constant X2y1 = 4570521351653056269193006501627448967031764700846404635353716329763847733209;
    uint256 constant X2y2 = 13921936629504945422578447522425751401494790947620636228686852301990651219287;
